...
namespace RestaurantMenu
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RestaurantContext>(opt => opt.UseSqlServer
            (Configuration.GetConnectionString("RestaurantConnection")));

            services.AddControllers();
            services.AddAutoMapper(AppDomain.CurrentDomain.GetAssemblies());
            //services.AddScoped<ICommanderRepo, MockCommanderRepo>();
            services.AddScoped<IRestaurantRepo, SqlRestaurantRepo>();
            services.AddScoped<IMenuItemRepo, SqlMenuItemRepo>();
